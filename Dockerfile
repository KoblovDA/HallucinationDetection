...
RUN apt-get update && apt-get install -y \
    curl wget git build-essential ca-certificates sudo \
    bzip2 libx11-6 unzip tmux \
...
RUN curl -sLo ~/miniconda.sh https://repo.anaconda.com/miniconda/Miniconda3-py310_23.1.0-1-Linux-x86_64.sh \
...
CMD jupyter notebook --allow-root --ip='0.0.0.0' --port=8881 --NotebookApp.token='' --NotebookApp.password=''